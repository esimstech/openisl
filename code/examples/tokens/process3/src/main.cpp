 ...
 *     Name: main.cpp
 *
 *     Description: process3: Tokens example.
 *
 *     Modification date: 14/06/2022
 *     Author: T. Roudier
...
int main(int argc, char *argv[])
{
	...
	if (cConnect.Create() == false) {
		ISLLogError(303, "Failed to setup the ISL session %s.", cConnect.GetSessionId().c_str());
		return -3;
	}
